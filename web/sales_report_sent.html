    ...
    <section class="home-section">
        ...
        <div class="head-user">
            ...
            <div class="head-title">
                <h2>Reportar producto como enviado</h2>
            </div>
        ...
        <div class="sales-report-content">
            <div class="text">
                <p>Te sugerimos usar la app para esta operación, ya que te permite leer el código QR que te dan en Correos de</p>
                <p>Costa Rica, o ingresar el número en la misma oficina de correos. Podés bajar la app <a href="#">aquí</a>.</p>
            </div>
            ...
            <div class="product"> 
                ...
                <div class="code-box">
                    ...
                    <p>Al entregar la orden en Correos de Costa Rica te tienen que haber dado un número de guía o seguimiento.</p>
                    
                    <div class="code-box-details">
                        <h2>Digitá el número aquí:</h2>
                        <div>
                            <input type="text"></input>
                            <btn type="button" class="table-btn"><span class="btn-text">Aceptar</span></btn>
                        </div>
                    </div>
