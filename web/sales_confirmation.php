...
<head>
    ...
    <title>Closetería | Mis Ventas</title>
    ...
    <section class="home-section">
        ...
        <div class="head-user">
            ...
            <div class="head-title">
                <h2>Producto reportado como enviado</h2>
            </div>
            
        </div>

        <div class="sales-confirmation-content">
            <div class="text">
                <p>¡Genial!</p>
                <p>Ana Loaiza recibió un email diciendo que ya su orden está en ruta.</p>
                <p>Una vez que haya recibido su pedido y lo haya reportado, te llegará una confirmación con el depósito de</p>
                <p>Esta venta (más el costo del envío) a tu cuenta.</p>
                <p>Para protección tuya, si Ana Loaiza no reporta el producto cuando lo recibe, de igual forma recibirás el pago</p>
                <p>en los siguientes días.</p>
            </div>

                
            <btn type="button" class="table-btn"><span class="btn-text">Regresar</span></btn>
        </div>
