    ...
    <section class="home-section">
        ...
        <div class="head-user">
            ...
            <div class="head-title">
                <h2>Por favor reportá tu compra como recibida para hacer el pago a la vendedora</h2>
            </div>
            
        </div>

        <div class="purchases-evaluation-content">
            <table class="product-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td data-label="Estado">Sin problemas</td>
                    </tr>
                </tbody>
            </table>

            <div class="evaluation-box">
                <h2>Opcional: Contanos cómo te fue con esta compra</h2>
                <div class="experience">
                    <h3>¿Cómo calificarías tu experiencia con Ana Loaiza?</h3>
                    <select name="experience">
                        <option value="Elegí una opción" disabled selected hidden>Elegí una opción</option>
                ...
                <div class="experience-details">
                    <h3>Si querés podés contarnos más o darnos detalles:</h3>
                    <input type="text"></input>
                </div>
            </div>
            
            <div class="evaluation-footer">
                <btn type="button" class="table-btn"><span class="btn-text">Reportar como recibido</span></btn>
                <p>Si por alguna razón no recibiste lo que pediste, escribinos aquí con fotos y toda la documentación necesaria.</p>
            </div>
