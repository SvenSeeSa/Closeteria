...
<body>
    ...
    <section class="home-section">
        <div class="home-content">
            ...
            <div class="head">
                <br>
                <h1 class="head-title">Publicar producto para la vente en tu "clóset" de Closetería</h1>
                <p class="head-subtitle">Vender en Closetería es fácil. Solo debés agregar las fotos, llenar algunos
                    datos, y listo. Asegurate de tener tu información bancaria correcta. Esto lo podés revisar en tu
                    Perfil.</p>
            </div>

            <div class="head-advertisement">
                <div class="ad"><i class="fas fa-exclamation-triangle"></i></div>
                <p class="advertisement">Recordá que la descripción debe ser exacta. Si tu prenda tiene desperfectos,
                    debés incluirlos todas en las fotografías y la descripción. Si lo haces y hay reclamos o se piden
                    devoluciones, estarás protegida.</p>
            </div>

            <div class="step-content">
                <h2 class="step-title">1-Agregá las fotografías de tu prenda</h2>
                <p class="step-text">Usá buena iluminación, pónelas contra un fondo blanco o contra el que se vean los
                    detalles. Usá fotos de distintos ángulos para que las compradoras tengan más información. Incluí
                    cualquier imperfección si es el caso.</p>
            </div>

            <div class="container btn-container">
                <button type="button" class="btn btn-primary"><i class="fas fa-cloud-upload-alt icon"></i>Subí tus
                    fotos</button>
                <p>o arrastralas</p>
            </div>

            <div class="step-content">
                <h2 class="step-title">2-Describí tu producto</h2>
                <form class="sell-form">
                    <div class="form-group form-group-2">
                        <label for="FormControlInputTitle">Título</label>
                        <input class="form-control" id="FormControlInputTitle"
                            placeholder="¿Qué vas a vender? (Requerido)">
                    </div>
                    <div class="form-group">
                        <label for="FormControlTextarea1">Descripción</label>
                        <textarea class="form-control" id="FormControlTextarea1" rows="3"
                            placeholder="Describí la prenda que vas a vender. Si es de segunda y tiene imperfecciones debés decirlo con detalle aquí."></textarea>
                    </div>
                    <div class="form-group form-group-3">
                        <label for="FormControlSelect1">Categoría</label>
                        <select class="form-control form-control-2" id="FormControlSelect1">
                            <option disabled selected>Elegí la categoría</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
                        ...
                        <select class="form-control form-control-2">
                            <option disabled selected>Subcategoría (opcional)</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
                    ...
                    <div class="form-group form-group-3">
                        ...
                        <select class="form-control form-control-2" id="FormControlSelectSize">
                            <option disabled selected>Elegí la talla</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
                    ...
                    <div class="form-group form-group-3">
                        ...
                        <select class="form-control form-control-2" id="FormControlSelectSize">
                            <option disabled selected>Máximo 2</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
                    ...
                    <div class="form-group form-group-3">
                        ...
                        <p class="input-text">Menos gastos de Closetería y costos de transacciones</p>
                    </div>
                    ...
                    <div class="form-group form-group-3">
                        ...
                        <label for="FormControlSelect2">Condición</label>
                        <select class="form-control form-control-2" id="FormControlSelectCondition">
                            <option disabled selected>Elegí tu opción</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
                    ...
                    <p class="input-text-2">Un SKU es una referencia que le podés dar a tu producto para llevar un control interno. Esto NO se muestra en Closetería.</p>
