...
<body>
    ...
    <section class="home-section">
        <div class="home-content">
            ...
            <div class="head">
                <img class="home-image" src="img/illustration.png" width="600" height="250"/>
                <br>
                <p>¡Bienvenida a Closetería!</p>
                <p>Una vez que comprés o vendás, aquí aparecerán los productos</p>

                <br>
                <br>
                <p>¿Por qué no hacer una platita extra?</p>
                <p>Andá a tu clóset, sacá esa ropa bonita que ya no usás, y ponela a la venta.</p>
                <p>Es gratis. Y toma 3 minutos.</p>
            </div>
